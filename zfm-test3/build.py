#!/usr/bin/env python3
"""Build ZFM Test 3 and retain source/configuration evidence; never flash."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    p.add_argument('--tag', default='zfm-t3-01')
    a = p.parse_args()
    ...
    metadata = {'test': 'ZFM Test 3', 'version': '1.0', 'board': a.board,
