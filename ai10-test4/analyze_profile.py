#!/usr/bin/env python3
"""Validate Test 4 stack profiles; values are cumulative observed watermarks."""
import argparse
import csv
import json
...
PHASES = ("sync_timeout", "async_timeout", "continuous_cancel")
EXPECTED_STACKS = {(p, "app_main") for p in ("before_operations", *PHASES)} | {
    (p, "ai10_worker") for p in PHASES[1:]}
...
def parse_profile(text):
    ...
    for session in sessions:
        ...
        if session["metadata"].get("stack_config") != ["4096", "2048"]:
        ...
        expected_order = [("before_operations", "app_main"), ("sync_timeout", "app_main"),
                          ("async_timeout", "app_main"), ("async_timeout", "ai10_worker"),
                          ("continuous_cancel", "app_main"), ("continuous_cancel", "ai10_worker")]
